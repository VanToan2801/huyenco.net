...
const BirthInput = ({ onAnalyze, loading, automationData }) => {
    ...
    // Kịch bản Tự động điền Form từ sự kiện Live Stream
    useEffect(() => {
        if (automationData) {
            setFormData(prev => ({
                ...prev,
                name: automationData.name || prev.name,
                gender: automationData.gender || prev.gender,
                year: automationData.year || prev.year,
                month: automationData.month || prev.month,
                day: automationData.day || prev.day,
                hour: automationData.hour ?? prev.hour
            }));
        }
    }, [automationData]);
    ...
    return (
        <div className="input-form-container fade-in">
            ...
            <header className="branding-header">
                ...
                <p className="brand-tagline">huyencobattu.net • Khám phá mật mã cuộc đời</p>
            </header>
