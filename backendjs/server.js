...
// Use number instead of `true` to avoid ERR_ERL_PERMISSIVE_TRUST_PROXY
...
app.use("/api/webhook", aiLimiter, webhookRoutes);
    ...
    endpoints: [
      {
        method: "GET",
        path: "/api/analyze",
        description: "Full BaZi analysis",
      },
      { method: "GET", path: "/api/chart", description: "Basic chart info" },
      {
        method: "GET",
        path: "/api/elements",
        description: "Ngũ hành analysis",
      },
      { method: "GET", path: "/api/stars", description: "Thần sát analysis" },
      {
        method: "GET",
        path: "/api/luck-cycles",
        description: "Đại vận analysis",
      },
      {
        method: "GET",
        path: "/api/year-analysis",
        description: "Lưu niên analysis",
      },
      {
        method: "GET",
        path: "/api/auspicious-dates",
        description: "Ngày tốt xấu",
      },
      {
        method: "POST",
        path: "/api/consultant/ask",
        description: "AI Consultant Q&A",
      },
      {
        method: "GET",
        path: "/api/consultant/stats",
        description: "Thống kê tư vấn",
      },
      {
        method: "GET",
        path: "/api/consultant/customers",
        description: "Danh sách khách hàng",
      },
      {
        method: "GET",
        path: "/api/consultant/history/:id",
        description: "Lịch sử tư vấn khách hàng",
      },
    ],
    parameters: {
...
(async () => {
  try {
    ...
    console.error(
      "[STARTUP] Critical Error: Failed to initialize database:",
      error.message,
    );
    process.exit(1);
  }
